 ...
 <nav x-data="{selected: $persist('Dashboard')}">
   ...
   <div>
     ...
     <ul class="flex flex-col gap-4 mb-6">
       ...
       <!-- Menu Item Utilisateur -->
       {{-- <li>
         <a href="" @click.prevent="selected = (selected === 'Utilisateur' ? '':'Utilisateur')" class="menu-item group" :class=" (selected === 'Utilisateur') || (page === 'ecommerce' || page === 'analytics' || page === 'marketing' || page === 'crm' || page === 'stocks') ? 'menu-item-active' : 'menu-item-inactive'">

            <svg
             :class="(selected === 'Utilisateur') && (page === 'Utilisateur') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'"
             width="24"
             height="24"
             viewBox="0 0 24 24"
             fill="none"
           ...
           <svg
             ...
             :class="[(selected === 'Utilisateur') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]"
             width="20"
             height="20"
             viewBox="0 0 20 20"
             fill="none"
         ...
         <!-- Dropdown Menu Start -->
         <div class="overflow-hidden transform translate" :class="(selected === 'Utilisateur') ? 'block' :'hidden'">
           <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
             <li>
               <a
                 href=""
                 class="menu-dropdown-item group"
                 :class="page === 'Vendeur' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
               >
                 Commandes
               </a>
             </li>
             <li>
               <a
                 href=""
                 class="menu-dropdown-item group"
                 :class="page === 'Acheteur' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
               >
                 Acheteurs
                 <span class="absolute flex items-center gap-1 right-3">
                   <span
                     class="menu-dropdown-badge"
                     :class="page === 'acheteurs' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                   >
                   </span>
                 </span>
               </a>
       ...
       <!-- Menu Item Profile -->
        <li>
            <a href="{{route('produits.index')}}" @click="selected = (selected === 'Mes produits' ? '':'produits')" class="menu-item group menu-item-inactive" :class=" (selected === 'Mes produits') &amp;&amp; (page === 'produits') ? 'menu-item-active' : 'menu-item-inactive'">
            <svg :class="(selected === 'Mes produits') &amp;&amp; (page === 'produits') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="menu-item-icon-inactive">
       ...
       <li>
         <a
           href=""
           @click.prevent="selected = (selected === 'Categorie' ? '':'Categorie')"
           class="menu-item group"
           :class=" (selected === 'Categorie') || (page === 'addCat' || page === 'showCat') ? 'menu-item-active' : 'menu-item-inactive'"
         >

          </svg>
           <svg
             :class="(selected === 'Categorie') || (page === 'addCat' || page === 'showCat') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
             width="24"
             height="24"
             viewBox="0 0 24 24"
             fill="none"
           ...
           <svg
             class="menu-item-arrow"
             :class="[(selected === 'Categorie') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]"
             width="20"
             height="20"
             viewBox="0 0 20 20"
             fill="none"
         ...
         <div
           ...
           :class="(selected === 'Categorie') ? 'block' :'hidden'"
         >
           <ul
           ...
           >
             <li>
               <a
                 href="{{route('categorie.add')}}" class="menu-dropdown-item group" :class="page === 'addCat' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
             ...
             <li>
               <a
                 ...
                 class="menu-dropdown-item group"
                 :class="page === 'showCat' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
               >
       ...
       <li>
         <a
           href=""
           @click.prevent="selected = (selected === 'SousCategorie' ? '':'SousCategorie')"
           class="menu-item group"
           :class=" (selected === 'SousCategorie') || (page === 'addSCat' || page === 'showSCat') ? 'menu-item-active' : 'menu-item-inactive'"
         >
           <svg
             :class="(selected === 'SousCategorie') || (page === 'addSCat' || page === 'showSCat') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
             width="24"
             height="24"
             viewBox="0 0 24 24"
             fill="none"
           ...
           <span
             ...
             :class="sidebarToggle ? 'lg:hidden' : ''"
           >
             Paiments et finances
           </span>

           <svg
             class="menu-item-arrow absolute top-1/2 right-2.5 -translate-y-1/2 stroke-current"
             :class="[(selected === 'SousCategorie') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]"
             width="20"
             height="20"
             viewBox="0 0 20 20"
             fill="none"
         ...
         <div
           class="overflow-hidden transform translate"
           :class="(selected === 'SousCategorie') ? 'block' :'hidden'"
         >
           <ul
             :class="sidebarToggle ? 'lg:hidden' : 'flex'"
             class="flex flex-col gap-1 mt-2 menu-dropdown pl-9"
           >
             <li>
               <a
                 href="{{route('sousCategorie.create')}}"
                 class="menu-dropdown-item group"
                 :class="page === 'addSCat' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
               >
             ...
             <li>
               <a
                 href="{{route('sousCategorie.index')}}"
                 class="menu-dropdown-item group"
                 :class="page === 'showSCat' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
               >
