      ...
      <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
        <li>
          ...
          >
            ...
            >
              <img
                src="{{asset('sotorage/assetsd/src/images/user/user-02.jpg')}}"
                alt="User"
        ...
        <li>
          ...
          >
            ...
            >
              <img
                src="{{asset('sotorage/assetsd/src/images/user/user-03.jpg')}}"
                alt="User"
                class="overflow-hidden rounded-full"
              />
              <span
        ...
        <li>
          ...
          >
            ...
            >
              <img
                src="{{asset('sotorage/assetsd/src/images/user/user-04.jpg')}}"
                alt="User"
                class="overflow-hidden rounded-full"
              />
              <span
        ...
        <li>
          ...
          >
            ...
            >
              <img
                src="{{asset('sotorage/assetsd/src/images/user/user-05.jpg')}}"
                alt="User"
                class="overflow-hidden rounded-full"
              />
              <span
...
>
  ...
  >
    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
      <img src="{{asset('sotorage/assetsd/src/images/user/owner.jpg')}}" alt="User" />
    </span>
  ...
  >
    <div>
      ...
      >
        <a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="99ebf8f7fdf6f4eceafcebd9e9f0f4f3f6b7faf6f4">[email&#160;protected]</a>
      </span>
    </div>
