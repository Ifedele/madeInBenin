<label    for="toggle-{{ $sousCategorie->id }}" class="flex cursor-pointer items-center gap-3 text-sm font-medium " wire:click="toggleEtat2" >
    ...
    ">
    <div x-show="categorieParenteDesactive" class="bg-error-100 border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
        <strong class="font-bold">Erreur!</strong>
        <span class="block sm:inline">La catégorie parente est désactivée.</span>
    </div>
