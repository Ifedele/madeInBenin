                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    @foreach ($sousCategories as $sousCategorie  )
                        <tr>
                            <td class="px-6 py-3 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        {{$sousCategorie->categorie->lib_cat}}
                                        </span>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-3 whitespace-nowrap">
                                <div x-data="{ switcherToggle: {{$sousCategorie->etat == 1 ? 'true' : 'false'}} }" class="flex items-center justify-center">

                                      @livewire('sous-categorie-status', ['sousCategorie' =>$sousCategorie])
                            ...
                            <td class="px-6 py-3 whitespace-nowrap">
                                <div class="flex items-center justify-center">
                                    <a href="{{route('sousCategorie.edit', ['id'=>$sousCategorie->id]) }}">
