...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <div class="p-5 space-y-6 border-t border-gray-100 dark:border-gray-800 sm:p-6">
      <form action="{{route('sousCategorie.update' ,$sousCategorie->id)}}" method="POST">
        @csrf
        @method('PUT')
        <div class="-mx-2.5 flex flex-wrap gap-y-5">
          ...
          <div class="w-full px-2.5">
            ...
            <div>
                ...
                <input name="lib_sous_cat" id="lib_sous_cat" value="{{$sousCategorie->lib_sous_cat}}" required type="text" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
              </div>
          </div>
          <div class="w-full px-2.5">
